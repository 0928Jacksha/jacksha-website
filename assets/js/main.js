    ...
    en: {
      ...
      pages: {
        home: {
          ...
          hero_action_code: "Open Code",
          hero_action_contact: "Open Contact",
          preview_title: "Four Working Lines",
          preview_intro: "Travel records scale. Photography records atmosphere. Code records systems. Perspective records meaning.",
          ...
          preview_code_title: "Code",
          preview_code_body: "Public repositories, active systems, and a documentation-style workspace built from live GitHub data.",
          ...
          code_home_title: "Code System",
          code_home_intro:
            "A GitHub-backed workspace for the projects I keep active: repository filtering, live source status, and module-based navigation.",
          code_home_live_label: "Live Source",
          code_home_live_title: "Public repos with current status.",
          code_home_live_body: "The code page reads from GitHub to surface repositories, sync state, and update timing in one place.",
          code_home_modules_label: "Modules",
          code_home_modules_title: "A docs-style way to enter each project.",
          code_home_modules_body:
            "Installation, quickstart, learning paths, and deeper module groups make each repository easier to inspect.",
          code_home_featured_label: "Featured Work",
          code_home_featured_title: "Highlighted projects stay close to the top.",
          code_home_featured_body:
            "The strongest current work is surfaced first, while the full set remains browsable underneath.",
          code_home_primary_cta: "Open Code Workspace",
          code_home_secondary_cta: "View GitHub",
          ...
          overview: {
            ...
            code_title: "Code Workspace",
            code_cta: "Open Code Workspace",
    ...
    zh: {
      ...
      pages: {
        home: {
          ...
          hero_action_code: "打开代码页",
          hero_action_contact: "进入联系",
          preview_title: "四条主线",
          preview_intro: "旅行记录尺度，摄影记录气氛，代码记录系统，视角记录意义。",
          ...
          preview_code_title: "代码",
          preview_code_body: "公开仓库、正在运行的系统，以及一个基于 GitHub 实时数据搭建的文档式工作界面。",
          preview_perspective_title: "视角",
          preview_perspective_body: "来自长距离经验的思考，以及地点背后的系统观察。",
          code_home_title: "代码系统",
          code_home_intro: "这是一个由 GitHub 驱动的工作界面，用来承载我仍在维护的项目：仓库筛选、实时状态和模块化导航都集中在这里。",
          code_home_live_label: "实时来源",
          code_home_live_title: "公开仓库带着当前状态一起呈现。",
          code_home_live_body: "代码页会直接从 GitHub 读取仓库、同步状态与最近更新时间，集中展示当前工作。",
          code_home_modules_label: "模块结构",
          code_home_modules_title: "用文档式方式进入每个项目。",
          code_home_modules_body: "安装、快速开始、学习路径和更深层的模块分组，让每个仓库都更容易被理解和查看。",
          code_home_featured_label: "重点项目",
          code_home_featured_title: "当前最强的工作会被放在更前面。",
          code_home_featured_body: "重点项目优先展示，完整项目集合仍然保留在下方可继续浏览。",
          code_home_primary_cta: "打开代码工作区",
          code_home_secondary_cta: "查看 GitHub",
          overview_title: "继续探索",
          overview: {
            travel_title: "旅行",
            travel_cta: "进入旅行页",
